...
type TestSuite struct {
	...
	Id           int64   `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	TestreportId int64   `protobuf:"varint,2,opt,name=testreport_id,json=testreportId,proto3" json:"testreport_id,omitempty"`
...
func (x *TestSuite) GetTestreportId() int64 {
	if x != nil {
...
type TestCase struct {
	...
	Id             int64                   `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	TestsuiteId    int64                   `protobuf:"varint,2,opt,name=testsuite_id,json=testsuiteId,proto3" json:"testsuite_id,omitempty"`
	TestreportId   int64                   `protobuf:"varint,3,opt,name=testreport_id,json=testreportId,proto3" json:"testreport_id,omitempty"`
	...
	RecentFailures *TestCaseRecentFailures `protobuf:"bytes,13,opt,name=recent_failures,json=recentFailures,proto3" json:"recent_failures,omitempty"`
}
...
func (x *TestCase) GetTestsuiteId() int64 {
	if x != nil {
...
func (x *TestCase) GetTestreportId() int64 {
	if x != nil {
		return x.TestreportId
	}
	return 0
...
func (x *TestCase) GetRecentFailures() *TestCaseRecentFailures {
	if x != nil {
...
type TestCaseRecentFailures struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *TestCaseRecentFailures) Reset() {
	*x = TestCaseRecentFailures{}
	if protoimpl.UnsafeEnabled {
...
func (x *TestCaseRecentFailures) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TestCaseRecentFailures) ProtoMessage() {}

func (x *TestCaseRecentFailures) ProtoReflect() protoreflect.Message {
	mi := &file_gitlabexporter_proto_models_testreport_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TestCaseRecentFailures.ProtoReflect.Descriptor instead.
func (*TestCaseRecentFailures) Descriptor() ([]byte, []int) {
	return file_gitlabexporter_proto_models_testreport_proto_rawDescGZIP(), []int{3}
}

func (x *TestCaseRecentFailures) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *TestCaseRecentFailures) GetBaseBranch() string {
	if x != nil {
		return x.BaseBranch
	}
	return ""
...
var file_gitlabexporter_proto_models_testreport_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x70, 0x69,
	...
	0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x23, 0x0a, 0x0d, 0x74, 0x65, 0x73, 0x74, 0x72,
	0x65, 0x70, 0x6f, 0x72, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c,
	...
	0xd3, 0x03, 0x0a, 0x08, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x28, 0x03, 0x52, 0x0b, 0x74, 0x65, 0x73, 0x74, 0x73, 0x75, 0x69, 0x74, 0x65, 0x49, 0x64, 0x12,
	0x23, 0x0a, 0x0d, 0x74, 0x65, 0x73, 0x74, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x5f, 0x69, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x74, 0x65, 0x73, 0x74, 0x72, 0x65, 0x70, 0x6f,
	...
	,
...
var file_gitlabexporter_proto_models_testreport_proto_goTypes = []interface{}{
	...
	(*TestCaseRecentFailures)(nil), // 3: gitlabexporter.proto.models.TestCaseRecentFailures
}
var file_gitlabexporter_proto_models_testreport_proto_depIdxs = []int32{
	3, // 0: gitlabexporter.proto.models.TestCase.recent_failures:type_name -> gitlabexporter.proto.models.TestCaseRecentFailures
...
func file_gitlabexporter_proto_models_testreport_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_gitlabexporter_proto_models_testreport_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TestCaseRecentFailures); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
